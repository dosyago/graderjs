...
System.register("index", ["path", "fs", "service", "lib/common", "config"], function (exports_5, context_5) {
    "use strict";
    var path_3, fs_2, Service, Common, config_js_4, API, App;
    var __moduleName = context_5 && context_5.id;
    // basic functions
    async function go({ apiInUI: apiInUI = false, titleBar: titleBar = true, // false  
    addHandlers: addHandlers = undefined, // callback to add the route handlers to an express app
